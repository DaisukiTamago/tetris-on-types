...
type NextTetromino<Seed extends number> = Mod<Seed, NumberOfTetrominoes> extends infer Index extends number ? 
    TetrominoToCoordinates<TetrominoList[Index]> : never